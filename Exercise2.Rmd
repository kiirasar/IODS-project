...
```
Select (with mouse or arrow keys) the install.packages("...") and run it (by Ctrl+Enter / Cmd+Enter):
...
# How many rows  does the data have? 183
# How many colums does the data have? 60

# Look at the structure of the data

str(lrn14) # see my comments on create_learning2014.R 
