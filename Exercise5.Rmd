...
pca_pre <- round(100*s$importance[2, ], digits =1)
...
pc_labe = paste0(names(pca_pre), " (", pca_pre, "%)")
pc_labe

# draw a biplot
biplot(pca_human, cex = c(0.8, 1), col = c("grey40", "deeppink2"), xlab = NA, ylab = NA)

biplot(pca_human, cex = c(0.8, 1), col = c("grey40", "deeppink2"), xlab = pc_labe[1], ylab = pc_labe[2])
