...
library(dplyr)
mat <- read.table("https://raw.githubusercontent.com/KimmoVehkalahti/Helsinki-Open-Data-Science/master/datasets/student-mat.csv", sep=";", header=TRUE)
port <- read.table("https://raw.githubusercontent.com/KimmoVehkalahti/Helsinki-Open-Data-Science/master/datasets/student-por.csv", sep=";", header=TRUE)

free_cols <- c("failures","paid","absences","G1","G2","G3")
join_cols <- setdiff(colnames(port), free_cols)
mat_port <- inner_join(mat, port, by = join_cols, suffix = c(".math", ".por"))
...
alc <- select(mat_port, all_of("change me"))
alc <- select(mat_port, all_of(join_cols))
View(alc)
